...
class ScoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scout" do
    assert_difference('Scout.count') do
      post scouts_url, params: { scout: { body: @scout.body, id: @scout.id, name: @scout.name, title: @scout.title, update_at: @scout.update_at } }
    end
  ...
  test "should update scout" do
    patch scout_url(@scout), params: { scout: { body: @scout.body, id: @scout.id, name: @scout.name, title: @scout.title, update_at: @scout.update_at } }
